...
class Rules extends JFrame implements ActionListener {
    ...
    Rules(String name) {
        ...
        JLabel heading = new JLabel("Welcome " + name + " Quiz2Me");
        heading.setBounds(400, 100, 400, 25);
        ...
        rule2.setText("2. Every Portion has 10 Questions, You have to correct 50 percent to pass Quiz.");
        add(rule2);
        ...
        rule3.setText("3. You have three for Quiz.");
        add(rule3);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == start) {
            ...
            setVisible(false);
           // new Login(); // this will open new window for login
        }
    }
