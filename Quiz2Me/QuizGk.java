...
public class QuizGk extends JFrame implements ActionListener {
    ...
    QuizGk(String name) {
        ...
        answers[0][1] = " Quaid-e-Azam ";
        answers[1][1] = "9 years";
        answers[2][1] = "12th March 1949";
        answers[3][1] = " Prime Minister ";
        answers[4][1] = "23rd March 1956";
        answers[5][1] = " Choudary Mohammad Ali ";
        answers[6][1] = "32";
        answers[7][1] = "Islamic Republic of Pakistan";
        answers[8][1] = " Both A&B ";
        answers[9][1] = " Sir Syed Ahmad Khan ";
