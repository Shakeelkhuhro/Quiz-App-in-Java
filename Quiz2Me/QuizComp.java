...
public class QuizComp extends JFrame implements ActionListener {
    ...
    QuizComp(String name) {
        ...
        answers[0][1] = "Preliminary Investigation";
        answers[1][1] = "New TechnologyFile System";
        answers[2][1] = "Domain Name System";
        answers[3][1] = "Arithmetic & Logic unit";
        answers[4][1] = "Modren";
        answers[5][1] = "Magnetic Ink Character Reader";
        answers[6][1] = "1.44MB";
        answers[7][1] = "Computer aided Design";
        answers[8][1] = "Printers";
        answers[9][1] = "Optical input device";
